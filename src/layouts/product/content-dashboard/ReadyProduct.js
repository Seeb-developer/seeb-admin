...
function ReadyProduct(props) {
  const { handleClickReadyProduct } = props;

  ReadyProduct.propTypes = {
    handleClickReadyProduct: PropTypes.func.isRequired,
  };
        ...
        <>
          {loading ? (
            ...
            <div>
              ...
              <div className="ml-4">
                <h3 className="font-bold text-lg ">Ready Product</h3>
              </div>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 flex justify-center gap-6 ">
                        <button
                          onClick={() => handleClickReadyProduct(el.id, el.title)}
                          // onClick={() =>
                          //   Navigate({
