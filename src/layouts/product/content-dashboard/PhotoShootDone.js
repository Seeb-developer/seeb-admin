...
function PhotoShootDone(props) {
  const { handleClickPhotoDone } = props;

  PhotoShootDone.propTypes = {
    handleClickPhotoDone: PropTypes.func.isRequired,
  };
        ...
        <>
          {loading ? (
            ...
            <div>
              ...
              <div className="ml-4">
                <h3 className="font-bold text-lg ">PhotoShoot Done</h3>
              </div>
                    ...
                    {listProduct.map((el, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 flex justify-center gap-6 ">
                          <button
                            onClick={() => handleClickPhotoDone(el.id, el.title)}
                            // onClick={() =>
                            //   Navigate({
