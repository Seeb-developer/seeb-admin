...
function ReadyProductList(props) {
  const { ListingReadyProduct, Titles } = props;

  ReadyProductList.propTypes = {
    ListingReadyProduct: PropTypes.func.isRequired,
  ...
  const getAllList = async (id) => {
    ...
    await fetch(
      process.env.REACT_APP_HAPS_MAIN_BASE_URL +
        `product/getProducts?home_zone_appliances_id=${ListingReadyProduct}&status=4`,
      requestOptions
    )
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="ml-4 flex gap-2">
                <h3 className="font-bold text-lg ">Listing Ready Product</h3>
