...
function LiveProductList(props) {
  const { ListingLive, Titles } = props;

  LiveProductList.propTypes = {
    ListingLive: PropTypes.func.isRequired,
  ...
  const getAllList = async (id) => {
    ...
    await fetch(
      process.env.REACT_APP_HAPS_MAIN_BASE_URL +
        `product/getProducts?home_zone_appliances_id=${ListingLive}&status=5`,
      requestOptions
    )
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="ml-4 flex gap-2">
                <h3 className="font-bold text-lg ">Listing Live Product</h3>
