...
function OfferList() {
  ...
  const removeOffer = (index) => {
    const updateOffer = listOffer.filter((_, i) => i !== index);
                ...
                {listOffer.map((el, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex justify-center">
                      <img
                        alt={el.image}
                        src={`${process.env.REACT_APP_HAPS_MAIN_BASE_URL + el.offer_mobile_path}`}
                    ...
                    <td className="px-6 py-4 flex justify-center gap-6 ">
                      ...
                      onClick={() => {
                        const newTab = window.open(
                          `/update-offer?${createSearchParams({ slug: el.id }).toString()}`,
                          '_blank'
                        );
                        newTab.focus();
                      }}
                      ...
                      <button onClick={() => handleOfferDelete(index, el.id)}>
                        <AiOutlineDelete />
                      </button>
                    </td>
                  </tr>
