    ...
    return (
        <DashboardLayout>
            ...
            <div className="border-solid border-2 black-indigo-600 mt-6">
                <div className="px-8 mt-5 text-lg font-semibold">List API History</div>
                            ...
                            {data.map((item, index) => (
                                <tr className="border-b dark:border-neutral-500" key={item.id}>
                                    ...
                                    <td className="text-center px-6 py-4">
                                        <a onClick={ ()=>navigate(`/api-uses`, { state: { id: item.user_id } }) } className="text-blue-500 hover:underline cursor-pointer">
                                            {item.name}
                                        </a>
                                    </td>
